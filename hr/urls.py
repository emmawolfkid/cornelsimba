...
urlpatterns = [
    ...
    path('leave/approvals/', views.leave_approval_list, name='leave_approval_list'),  # List page
    path('leave/<int:leave_id>/approve/', views.leave_approve_reject, name='leave_approve_reject'),  # Approval form
    ...
    # Add these to your urlpatterns in hr/urls.py
